...
API_KEY = "API_KEY" # replace API_KEY with your own YouTube API key credentials
...
if API_KEY == "API_KEY":
    print("Change the API_KEY variable at line 6 to your own\nEx: API_KEY = \"AIzaSyXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX\"")
    quit()
